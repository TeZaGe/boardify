# SKILLS & RÈGLES DE DÉVELOPPEMENT (Projet : Boardify)
...
Il s'agit d'un CRM de recherche d'emploi. La gestion se fait via un dashboard Kanban en drag & drop avec des outils de suivi et d'analyse des candidatures.